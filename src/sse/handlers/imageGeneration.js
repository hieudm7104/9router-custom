...
export async function handleImageGeneration(request) {
  ...
  if (comboModels) {
    ...
    return handleComboChat({
      body,
      models: comboModels,
      handleSingleModel: (b, m) => handleSingleModelImage(b, m, { wantsStream, binaryOutput, preferredConnectionId, keyRecord }),
      log,
      comboName: modelStr,
      comboStrategy,
      comboStickyLimit,
  ...
  return handleSingleModelImage(body, modelStr, { wantsStream, binaryOutput, preferredConnectionId, keyRecord });
}
...
async function handleSingleModelImage(body, modelStr, { wantsStream, binaryOutput, preferredConnectionId, keyRecord } = {}) {
  ...
  while (true) {
    ...
    const credentials = await getProviderCredentials(provider, excludeConnectionIds, model, { preferredConnectionId, allowedConnectionIds, connectionPriority });
